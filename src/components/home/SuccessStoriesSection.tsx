...
const testimonials = [
  {
    ...
    story: "After 5 years of disappointment and two failed cycles elsewhere, Dr. Maheshwari was a beacon of hope. Her personalized approach and the incredible care team made all the difference. We are now blessed with a beautiful baby girl.",
    rating: 5,
    isVideo: true,
  },
  {
    ...
    name: "Sarah & David M.",
    location: "London, UK",
    story: "Traveling to India for IVF was a big decision, but choosing this clinic was the best choice we ever made. The facility is world-class, but it's the genuine warmth and compassion of Dr. Maheshwari that truly stands out.",
    rating: 5,
    isVideo: false,
  },
  {
